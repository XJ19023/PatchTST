...
if plot_fig:
    ...
    # 为每个柱状图分配不同的颜色
    colors = [(120/255, 183/255, 201/255), (187/255, 151/255, 39/255), (50/255, 184/255, 151/255), (199/255, 109/255, 162/255)]
    ...
    for i in range(4):
        idx = i + base
        ax.bar(xticks[idx], tensor[idx], width=bar_width, edgecolor='black', color=colors[i], linewidth=0.5, label=hw_arch[i], zorder=3)
    ...
    plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.18), ncol=4, fontsize=9) 
    for i in range(7):
